...
class ApptainerRuntime(ExecutionEnvironment):
    ...
    def __init__(self, ds, repo_path="/testbed", alt_path="/root", docker_image=None, 
        ...
        # Convert Docker image to Apptainer URI
        ...
        # Start container and setup environment (base class handles setup)
        self.start_container(self.apptainer_image, command, self.container_name, **kwargs)
        self.setup_env()
    ...
    def stop_container(self):
        ...
        if self.container_name:
            try:
                ...
                self.logger.warning(f"Error stopping Apptainer instance: {e}")
            finally:
                self.container = None
                self.container_name = None
    
    def run(self, code: str, timeout: int = CMD_TIMEOUT, args: str = "", 
            workdir=None, type: str = None) -> Tuple[str, str]:
    ...
    def demux_run(self, code: str, timeout: int = CMD_TIMEOUT, args: str = "", 
                  workdir=None) -> Tuple[str, str, str]:
